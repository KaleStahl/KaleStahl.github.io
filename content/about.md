...
My current research interests lie within applied anlaysis and PDE, and I am particularly fond of mathematical application to physics, especially within wave equations. I did most of my undergraduate work on Inverse Scattering problems and their numerical solutions. I have ventured into more modern "mathematical physics" but the sheer amount of representation theory and Lie algebras have made me lean closer to applied analysis. I am still interested in the PDE that arise from general relativity, but there isn't much math that can be done there at the moment I feel strongly towards doing. Maybe after I study some more I can figure something cool out.

Outside of math, I have too many hobbies. I enjoy woodworking, playing video games, playing card games, coding, sculpting, cooking, and whatever else I decide I want to do that day. I enjoy of Nintendo games from all eras. I own every Nintendo console except for a SNES (I have the SNES mini, which I count since I modded it so it can play whatever I want). My favorite games are Monster Hunter (4U is forever the best), The Legend of Zelda (Windwaker obviously), and Stardew Valley, but I have played way too many games to list them all here. 

I have a 3 year old german shepard and coonhound mix named Boo who is... let's just say "special". We also recently adopt a cat name Celery! She is very cute and we hope her and Boo will be best friends. (It looks promising after the first few weeks)
